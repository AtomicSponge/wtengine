...
class input {
    ...
    private:
        ...
        inline static void run_handles(const ALLEGRO_EVENT& event) {
            //  Keyboard events
            if constexpr (handler_registers[S][WTE_EVENT_KEY_DOWN]) {
            ...
            if constexpr (handler_registers[S][WTE_EVENT_KEY_UP]) {
            ...
            //  Mouse events
            if constexpr (handler_registers[S][WTE_EVENT_MOUSE_AXIS]) {
            ...
            if constexpr (handler_registers[S][WTE_EVENT_MOUSE_BUTTON_DOWN]) {
            ...
            if constexpr (handler_registers[S][WTE_EVENT_MOUSE_BUTTON_UP]) {
            ...
            if constexpr (handler_registers[S][WTE_EVENT_MOUSE_WARPED]) {
            ...
            if constexpr (handler_registers[S][WTE_EVENT_MOUSE_ENTER_DISPLAY]) {
            ...
            if constexpr (handler_registers[S][WTE_EVENT_MOUSE_LEAVE_DISPLAY]) {
            ...
            //  Joystick events
            if constexpr (handler_registers[S][WTE_EVENT_JOYSTICK_AXIS]) {
            ...
            if constexpr (handler_registers[S][WTE_EVENT_JOYSTICK_BUTTON_DOWN]) {
            ...
            if constexpr (handler_registers[S][WTE_EVENT_JOYSTICK_BUTTON_UP]) {
            ...
            //  Touch events
            if constexpr (handler_registers[S][WTE_EVENT_TOUCH_BEGIN]) {
            ...
            if constexpr (handler_registers[S][WTE_EVENT_TOUCH_END]) {
            ...
            if constexpr (handler_registers[S][WTE_EVENT_TOUCH_MOVE]) {
            ...
            if constexpr (handler_registers[S][WTE_EVENT_TOUCH_CANCEL]) {
