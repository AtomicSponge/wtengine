...
g++ -o build/wte_demo main.o wte_demo.o -I"$PROJECT_DIR"/include -L"$PROJECT_DIR"/build -zmuldefs -lwtengine -lphysfs -lpthread `pkg-config --libs allegro-5 allegro_main-5 allegro_physfs-5 allegro_audio-5 allegro_acodec-5 allegro_font-5 allegro_image-5 allegro_primitives-5`
