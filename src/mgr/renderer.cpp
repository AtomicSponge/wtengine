...
void renderer::render(void) {
    ...
    if(config::flags::game_started) {
         ...
         */
        al_draw_scaled_bitmap(mgr::assets::secret_get<al_bitmap>("background_bitmap").bitmap(), 0, 0,
                              al_get_bitmap_width(mgr::assets::secret_get<al_bitmap>("background_bitmap").bitmap()),
                              al_get_bitmap_height(mgr::assets::secret_get<al_bitmap>("background_bitmap").bitmap()),
            ...
            try {
                if(mgr::entities::get_component<cmp::visible>(it.first)->check()) {
                    if(it.second->draw_tinted())
                        al_draw_tinted_bitmap(mgr::assets::secret_get<al_bitmap>(it.second->get_bitmap()).bitmap(), it.second->get_tint(), 0, 0, 0);
                    else
                        al_draw_bitmap(mgr::assets::secret_get<al_bitmap>(it.second->get_bitmap()).bitmap(), 0, 0, 0);
                }
                ...
                if(mgr::entities::get_component<cmp::visible>(it.first)->check()) {
                    if(it.second->draw_tinted())
                        al_draw_tinted_bitmap(
                            mgr::assets::secret_get<al_bitmap>(it.second->get_bitmap()).bitmap(), it.second->get_tint(),
         ...
         */
        al_set_target_backbuffer(al_get_current_display());
        al_draw_scaled_bitmap(mgr::assets::secret_get<al_bitmap>("arena_bitmap").bitmap(), 0, 0, arena_w, arena_h,
         ...
         */
        al_draw_scaled_bitmap(mgr::assets::secret_get<al_bitmap>("title_bitmap").bitmap(), 0, 0,
                              al_get_bitmap_width(mgr::assets::secret_get<al_bitmap>("title_bitmap").bitmap()),
                              al_get_bitmap_height(mgr::assets::secret_get<al_bitmap>("title_bitmap").bitmap()),
                              0, 0, screen_w, screen_h, 0);
    }
