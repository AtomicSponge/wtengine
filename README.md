...
WTEngine (What the Engine?) is a cross-platform game engine based on [ESC](https://en.wikipedia.org/wiki/Entity_component_system) design that can be used to make a simple 2D action game.
