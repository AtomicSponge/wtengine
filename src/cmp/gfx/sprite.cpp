...
{
    if(rate == 0) rate = 1;
    sheet_width = al_get_bitmap_width(mgr::assets::get<al_bitmap>(get_bitmap()).bitmap());
    sheet_height = al_get_bitmap_height(mgr::assets::get<al_bitmap>(get_bitmap()).bitmap());
}
