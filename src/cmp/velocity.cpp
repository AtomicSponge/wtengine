 ...
 *
 */
void velocity::set_x_vel(const float& xv) { x_vel = xv; }

/*
 *
 */
void velocity::set_y_vel(const float& yv) { y_vel = yv; }
 ...
 *
 */
const float velocity::get_x_vel(void) const { return x_vel; }

/*
 *
 */
const float velocity::get_y_vel(void) const { return y_vel; }
